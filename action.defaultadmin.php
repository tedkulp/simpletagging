...
$tabheaders .= 	$this->SetTabHeader('tagsearchtemplate',$this->Lang('title_tagsearchtemplate'),('tagsearchtemplate' == $tab)).
		$this->SetTabHeader('tagcloudsettings',$this->Lang('title_tagcloudsettings'),('tagcloudsettings' == $tab)).
